...
public class CustomTtlCacheManager extends ConcurrentMapCacheManager {
    ...
    public void clearCurrencyRatesAtSpecificTime() {
        // Clear currency rates cache at 16:00 CET (Central European Time) every working day
        // This is to ensure that the currency conversion rates are up-to-date per Frankfurter API
